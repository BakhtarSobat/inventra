...
private fun ConfigurationContent(
    ...
    Column(
        ...
        OutlinedTextField(
            value = data.pincode?.value.orEmpty(),
            onValueChange = { onPincodeChange(Pincode(it)) },
            label = { com.bsobat.inventra.ui.components.Text(stringResource(R.string.pin)) },
            singleLine = true,
